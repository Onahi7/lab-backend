...
export class OrdersService {
  ...
  async create(createOrderDto: CreateOrderDto, userId?: string): Promise<Order> {
    ...
    const order = new this.orderModel({
      ...
      externalFacilityId: (createOrderDto as any).externalFacilityId,
      externalFacilityName: (createOrderDto as any).externalFacilityName,
      sourceSystem: (createOrderDto as any).sourceSystem,
      sourceFacilityName: (createOrderDto as any).sourceFacilityName,
      sourceFacilityLocation: (createOrderDto as any).sourceFacilityLocation,
      externalRequestId: (createOrderDto as any).externalRequestId,
      referredByDoctor,
