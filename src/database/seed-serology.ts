...
async function seedSerology() {
  ...
  const tests = [
    // ==================== SEROLOGY ====================
    {
      ...
      turnaroundTime: 30,
      isActive: false,
      description: 'HBsAg rapid test — Reactive / Non-Reactive (panel-only)',
    },
    {
      code: 'HBSAB',
      ...
      turnaroundTime: 30,
      isActive: false,
      description: 'HBsAb rapid test — Reactive / Non-Reactive (panel-only)',
    },
    {
      code: 'HBEAG',
      ...
      turnaroundTime: 30,
      isActive: false,
      description: 'HBeAg rapid test — Reactive / Non-Reactive (panel-only)',
    },
    {
      code: 'HBEAB',
      ...
      turnaroundTime: 30,
      isActive: false,
      description: 'HBeAb rapid test — Reactive / Non-Reactive (panel-only)',
    },
    {
      code: 'HBCAB',
      ...
      turnaroundTime: 30,
      isActive: false,
      description: 'HBcAb rapid test — Reactive / Non-Reactive (panel-only)',
    },
    {
      code: 'HCV',
